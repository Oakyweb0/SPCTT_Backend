    ...
    try {
      ...
      await pool.query(`
        CREATE TABLE IF NOT EXISTS \`payments\` (
          ...
          \`payment_method\` VARCHAR(100) DEFAULT 'Axis Razorpay (PAGE WORLDWIDE)',
    ...
    try {
      ...
      const [result] = await pool.query(
        ...
        [
          ...
          paymentData.payment_method || 'Axis Razorpay (PAGE WORLDWIDE)',
  ...
  async getHistoryByUserId(userId) {
    try {
      ...
      return registrations.map(reg => ({
        ...
        payment_method: reg.payment_method || 'Axis Razorpay (PAGE WORLDWIDE)',
